    ...
    <>
      ...
      >
        <div className="container mx-auto px-6 flex items-center justify-between">
          <Link href="/" className="font-serif text-2xl tracking-widest text-accent z-50">
            ESSENCE SUPRÊME
          </Link>
          
          <nav className="hidden md:flex space-x-12 tracking-wide text-sm font-light">
          ...
          <div className="flex items-center space-x-6 z-50 md:hidden">
            <CartDrawer />
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          ...
          >
            <nav className="flex flex-col space-y-8 text-center text-xl font-serif tracking-widest">
